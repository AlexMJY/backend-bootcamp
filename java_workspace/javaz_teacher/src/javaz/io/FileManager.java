...
public class FileManager {
	...
	public void openFile() throws IOException {
		...
		System.out.print(">> 선택 : ");
		switch (reader.readLine()) {	 
		case "1":	//파일 내용 추가 - 파일을 덧붙이기 모드로 열기
					fw = new FileWriter(file, true); 	
					System.out.println(">> 추가하실 내용을 입력해 주세요." +
									   "(종료는 /q)");
					break;
		case "2":	//파일 내용 변경 - 기본 모드로 열기
					fw = new FileWriter(file);	 	
					System.out.println(">> 변경하실 내용을 입력해 주세요." +
							   		   "(종료는 /q)");		
					break; 
		case "3":	//이름 변경
					System.out.println(">> 변경하실 파일명을 입력해 주세요.");
					setFilename();
	...
	public void list() throws IOException {
		...
		System.out.println(src.getCanonicalPath() + " 디렉터리");				
		System.out.println();
