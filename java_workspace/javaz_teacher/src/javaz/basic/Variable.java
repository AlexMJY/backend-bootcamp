...
//- 가장 마지막에 저장된 값을 기억
//- 중괄호 블럭 { } 내부에 선언하여 사용
//  - 선언 : 변수의 종류에 따라 각기 다른 크기의 메모리
//			공간 확보
//  - 선언된 블럭 내에서만 유효
//  - 선언 후 초기화 또는 선언과 동시에 초기화하거나
//    초기화 되어 사용
...
//		float f = 0.12345678901234567890;	//4바이트
		...
		System.out.printf("평균 : %9.2f", sum/3.0);
		System.out.println();	
