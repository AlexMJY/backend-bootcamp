...
//													 };
		...
		double[][] pct = new double[][] { { 0.1, 0.2 },
										  { 0.3, 0.4 } };
		String[][] levels = { { "AA", "BB" },
							  { "CC", "DD", "EE"}    };
		
		System.out.println("pct 배열의 길이 : " + pct.length);
		System.out.println("pct 배열의 첫번째 행 길이 : " + pct[0].length );
		System.out.println("pct 배열의 두번째 행 길이 : " + pct[1].length);		
		System.out.println();
		System.out.println("levels 배열의 길이 : " + levels.length );					
		System.out.println("levels 배열의 첫번째 행 길이 : " + levels[0].length );
		System.out.println("levels 배열의 두번째 행 길이 : " + levels[1].length);
			
		System.out.println("pct 배열의 데이터 - for");
