...
public class Method {
	final static double PI = 3.14;	//1. 3.14를 공유 상수 PI에 저장
	private String type;	//2. 문자열 변수 type을 선언
							//   단, 클래스 외부에서는 접근 할 수 없도록 처리
	...
	//직사각형의 넓이를 계산하여 출력, 매개변수 : 가로, 세로의 길이
...
//	반환타입이 다른 것은 X
//	매개변수의 타입, 개수, 순서가 다른 것은 O
//		System.out.println(length * length);	
//	}
	
	
	//Method 클래스의 객체 type과 PI값을 문자열로 반환
