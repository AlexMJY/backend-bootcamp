	...
	<div class="container">
		<form action="result2.jsp" method="post" enctype="multipart/form-data">
			<table class="table table=hover">
				<tr>
					<th>제목</th>
					<td><input type="text" name="title" id="" value="hello"/></td>
				</tr>
	
				<tr>
					<th>작성자</th>
					<td><input type="text" name="writer" id="" value="max" /></td>
				</tr>
	
				<tr>
					<th>내용</th>
					<td><textarea name="contents" id="" cols="30" rows="10" >nice to meet you</textarea></td>
				</tr>
