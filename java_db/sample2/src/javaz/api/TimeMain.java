...
public class TimeMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("지금은 " 	+ ld.getMonth() + 
						   " "  	+ ld.getMonthValue() + "월");
		System.out.println("오늘은 " 	+ ld.getDayOfWeek() +
						   " " 		+ ld.getDayOfWeek()
						   		        .getValue() + "요일");
		System.out.println();
		...
		System.out.println("이 달의 첫요일은 " + 
						   ldt.with(TemporalAdjusters.firstDayOfMonth())
							  .getDayOfWeek() + " " +
						   ldt.with(TemporalAdjusters.firstDayOfMonth())
							  .getDayOfWeek().getValue() + "요일");
		System.out.println("이 달의 마지막날은 " + 
						   ldt.with(TemporalAdjusters.lastDayOfMonth())
							  .getDayOfMonth() + "일");
		System.out.println();
		
		/////////////////////////////////////////////////////
		//명령행 매개변수로 생년월일을 입력받아 
		LocalDate birth = LocalDate.parse(args[0]);  //LocalDate 타입의 변수 birth에 저장
		ld = LocalDate.now();
		System.out.println("19세가 되는 해 " + 
						   birth.plusYears(19).getYear());
		...
		System.out.println(birth.isAfter(ld) ? "생일 이전"  : "");
		System.out.println(birth.isEqual(ld) ? "생일"  : "");
		System.out.println(birth.isBefore(ld)? "생일 이후" : "");
