...
//		instanceNum += 1;
	...
	//생성되는 참조변수의 이름을 매개변수로 넘겨받아서
	//인스턴스 필드 instanceName을 초기화하는 생성자를 작성
		//생성된 인스턴스의 누적 개수는 instanceNum 필드에 저장
		//생성된 인스턴스의 이름과 누적 개수를 다음과 같이 출력
		//"생성된 인스턴스 이름 : ~~, 누적 인스턴스 수:~~"
