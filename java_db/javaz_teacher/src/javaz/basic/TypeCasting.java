...
public class TypeCasting {
	...
	public static void main(String[] args) {
		byte one = 1;
		byte two = 2;
		byte sam = 1 + 2;	 //데이터 연산  O
//			 sam = one + two;//타입 연산 x
//			 sam = (byte)one + (byte)two; //X
			 sam = (byte)(one + two); //강제형변환
	
		int oneTwo = one + two;//자동형변환
		...
		System.out.println("문자 \"ch\"의 아스키코드는 ~~");
