...
class ThreadA extends Thread {
	public void run() {	System.out.println("This is ThreadA");	}
}

class RunnableB implements Runnable {
	@Override
	public void run() {	System.out.println("This is RunnableB"); }
}
...
interface InterfaceD {
	public int method(int x, int y);//매개변수 2개, 반환값 X
}
...
public class LambdaMain {
	...
	public static void main(String[] args) {
		...
		c = () -> Math.PI;	//return문 하나만인 경우 
		System.out.println("return 3 : " + c.method());
